        ...
        contactForm: function () {
            ...
            if ($contactForm.length > 0) {
                ...
                $contactForm.each(function () {
                    var elem = $(this),
                        elemSuccessMessage = elem.attr('data-success-message') || "Seu orçamento foi enviado com <strong>Sucesso</strong>.";
                    ...
                    elem.validate({
                        submitHandler: function (form) {
                            ...
                            button.html('<i class="fa fa-refresh fa-spin"></i> Enviando...');
                                ...
                                success: function (text) {
                                    if (text.response == 'success') {
                                        ...
                                        button.html(buttonText);
                                            ...
                                            $('.shop').html('<div class="alert alert-info"><p>Orçamento enviado. Logo retornaremos.</p></div>');
